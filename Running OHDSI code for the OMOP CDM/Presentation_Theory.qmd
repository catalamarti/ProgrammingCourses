...
Second let's pick a topic: we are going to build a concept set of pancreatitis.

## CodelistGenerator

Example how to build a concept set:

1) Connect to a database (in this case eunomia):
...
<!-- ## inspect candidate codes -->
<!-- # for example, in AKI we have a code for "At risk of AKI" -->
<!-- # we exclude that concept from our definition -->
<!-- aki <- aki %>% -->
<!--   filter(!(str_detect(concept_name, "At risk of"))) -->

<!-- # save -->
<!-- write.csv2(pancreatitis, here("codes_pancreatitis.csv")) -->
<!-- write.csv2(aki, here("codes_AKI.csv")) -->
